            ...
            <div className="about-story-visual" data-reveal="left" data-reveal-delay="0.15">
              <div className="story-image-wrap">
                ...
                <img 
                  ...
                  alt="Sourcing Ayurvedic herbs and handcrafted products directly from fields and artisans" 
                  loading="lazy"
                  onError={(e) => {
                    e.target.style.display = 'none';
                    e.target.parentNode.querySelector('.story-fallback-visual').style.display = 'flex';
                  }}
                />
                <div className="story-fallback-visual" style={{ display: 'none' }}>
          ...
          <div className="infra-grid">
            <div className="infra-visual" data-reveal="right">
              <img 
                ...
                alt=" 중앙 warehouse and corporate logistics office in Gurgaon, Haryana" 
                loading="lazy"
                onError={(e) => {
                  e.target.style.display = 'none';
                  e.target.parentNode.querySelector('.infra-fallback').style.display = 'flex';
                }}
              />
              <div className="infra-fallback" style={{ display: 'none' }}>
          ...
          <div className="leader-profile" data-reveal="up" data-reveal-delay="0.1">
            <div className="leader-avatar">
              <img 
                ...
                alt="Mr Om Prakash Sharma — Founder & Managing Director of Opésh Overseas" 
                loading="lazy"
                onError={(e) => {
                  e.target.style.display = 'none';
                  e.target.parentNode.querySelector('.leader-initial').style.display = 'flex';
                }}
              />
              <span className="leader-initial" style={{ display: 'none' }}>OS</span>
            </div>
